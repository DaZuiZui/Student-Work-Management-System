        ...
        <el-col :span="50"><div class="grid-content bg-purple">
          <div>
            <div class="rcorners1">
              <div class="mydiv">
                <el-card >
                  <div style="text-indent: 30px;letter-spacing: 40px;  font-weight: 900;color: #a2f1b3; font-size: 30px">教师登录</div>
                </el-card>
              </div>
            </div>
...
export default {
  ...
  methods:{
    ...
    loginA(){
      this.$axios('/root/login?username=' +this.username +"&password="+this.password).then(res=>{
